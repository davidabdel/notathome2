...
const styles: Record<string, React.CSSProperties> = {
  ...
  startBtn: { width: '100%', padding: '16px', background: '#10b981', color: '#fff', border: 'none', borderRadius: 12, fontSize: 17, fontWeight: 700, cursor: 'pointer', marginBottom: 16 },
  ...
  joinInput: { flex: 1, border: '1.5px solid #d1d5db', borderRadius: 8, padding: '10px 14px', fontSize: 18, letterSpacing: '0.1em', outline: 'none', textAlign: 'center' },
  joinBtn: { background: '#2563eb', color: '#fff', border: 'none', borderRadius: 8, padding: '10px 16px', fontSize: 14, fontWeight: 600, cursor: 'pointer' },
  ...
  iconBtn: { background: '#f3f4f6', border: 'none', borderRadius: 8, width: 36, height: 36, cursor: 'pointer', fontSize: 16 },
  ...
  modal: { background: '#fff', borderRadius: '20px 20px 0 0', padding: '24px 20px 32px', width: '100%', maxWidth: 500, maxHeight: '80vh', overflowY: 'auto' },
  mapGrid: { display: 'grid', gridTemplateColumns: 'repeat(5,1fr)', gap: 8 },
  mapBtn: { padding: '14px 4px', background: '#f9fafb', border: '1.5px solid #e5e7eb', borderRadius: 10, fontSize: 15, fontWeight: 600, cursor: 'pointer' },
  mapBtnSelected: { background: '#eff6ff', border: '2px solid #2563eb', color: '#2563eb' },
  cancelBtn: { padding: '10px 20px', background: '#f3f4f6', border: 'none', borderRadius: 8, fontSize: 14, cursor: 'pointer' },
  createBtn: { padding: '10px 24px', background: '#2563eb', color: '#fff', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
};
